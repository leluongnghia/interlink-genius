...
class Admin {
	...
	public function override_links_page_assets() {
		...
		$inline_js .= '};';
		$inline_js .= 'rankMath.dashboardHeader = {';
		$inline_js .= '  dashboardUrl: ' . wp_json_encode( esc_url( admin_url( 'admin.php?page=interlink-genius' ) ) ) . ',';
		$inline_js .= '  proBadge: ""';
		$inline_js .= '};';
		$inline_js .= 'rankMath.keywordsApi = {';
		$inline_js .= '  url: "https://api.rankmath.com/ltkw/v1/"';
		$inline_js .= '};';
		$inline_js .= 'rankMath.validationl10n = {';
		$inline_js .= '  regexErrorDefault: "Please use the correct format.",';
		$inline_js .= '  requiredErrorDefault: "This field is required.",';
		$inline_js .= '  emailErrorDefault: "Please enter a valid email address.",';
		$inline_js .= '  urlErrorDefault: "Please enter a valid URL."';
		$inline_js .= '};';
