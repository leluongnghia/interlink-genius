...
class Posts_Controller extends Base_Controller {
	...
	public function regenerate_links( $request ) {
		...
		if ( ! $started ) {
			return $this->error(
				'no_posts_found',
				__( 'No posts found to process.', 'interlink-genius' ),
				400
			);
		}
	...
	private function get_posts_args() {
		return [
			...
			'search'             => [
				'description' => esc_html__( 'Search in post title.', 'interlink-genius' ),
				'type'        => 'string',
				'default'     => '',
			],
			'post_type'          => [
				'description' => esc_html__( 'Filter by post type. Supports multiple values.', 'interlink-genius' ),
				'type'        => 'array',
				'items'       => [ 'type' => 'string' ],
				'default'     => [],
			],
			'is_orphan'          => [
				'description' => esc_html__( 'Filter by orphan status.', 'interlink-genius' ),
				'type'        => 'string',
				'default'     => '',
			],
			'seo_score_range'    => [
				'description' => esc_html__( 'Filter by SEO score range.', 'interlink-genius' ),
				'type'        => 'string',
				'default'     => '',
			],
			'orderby'            => [
			...
			'min_incoming_links' => [
				'description' => esc_html__( 'Minimum incoming links count filter.', 'interlink-genius' ),
				'type'        => 'integer',
				'default'     => 0,
			],
		];
