...
namespace InterLinkGenius\Blocks\Related;
...
class Block_Related_Posts {
	...
	public function register() {
		...
		register_block_type(
			INTERLINK_GENIUS_DIR . 'blocks/related/assets/src/block.json',
			[
	...
	public function render( $attributes, $content, $block ) {
		...
		if ( empty( $items ) && $in_editor && ! metadata_exists( 'post', $post_id, 'interlink_genius_related_posts' ) ) {
